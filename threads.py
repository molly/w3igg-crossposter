...
def send_threads(post_text, num_screenshots, entry_details):
    """
        ...
        try:
            ...
            try:
                ...
                for ind in range(num_screenshots):
                    ...
                    alt_text = alt_text[:THREADS_ALT_TEXT_LIMIT]
                    ...
                    WebDriverWait(driver, 10).until(
                        expected_conditions.presence_of_element_located(
                            (
                                By.XPATH,
                                "//*[contains(text(), 'Describe this for people')]",
                            )
                        )
                    )
                ...
                logger.error("Something else went wrong during Threads post.")
                logger.error(e)
                driver.quit()
